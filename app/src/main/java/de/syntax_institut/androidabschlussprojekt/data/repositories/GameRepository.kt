        ...
        return try {
            ...
            if (resp.isSuccessful) {
                ...
                resp.body()?.let { gameDto ->
                    AppLogger.d("GameRepository", "[DEBUG] API-Response erhalten: ${gameDto.name}")
                    AppLogger.d(
                        "GameRepository",
                    ...
                    gameDto.shortScreenshots?.forEachIndexed { index, screenshot ->
                        AppLogger.d("GameRepository", "API Screenshot $index: ${screenshot.image}")
                    }
                    ...
                    AppLogger.d("GameRepository", "[DEBUG] Separate Movies geladen: ${movies.size}")
                    ...
                    val game =
                        gameDto.toDomain()
                            .copy(
                                screenshots =
                                    screenshots.ifEmpty { existingScreenshots },
                    ...
                    val mergedGame =
                        if (cachedGame != null) {
                            game.copy(
                                screenshots =
                                    game.screenshots.ifEmpty { cachedGame.screenshots },
                    ...
                    if (cachedGame == null || mergedGame != cachedGame) {
                        try {
                            ...
                            CrashlyticsHelper.setCustomKey("cache_error", e.javaClass.simpleName)
                            AppLogger.e(
                                "GameRepository",
