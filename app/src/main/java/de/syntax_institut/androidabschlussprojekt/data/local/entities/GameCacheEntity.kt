 ...
 * Speichert Spieldaten lokal für Offline-Zugriff und Cache-Invalidierung.
 *
 ...
 * @property cachedAt Zeitstempel, wann das Spiel gecacht wurde
 * @property searchQuery Suchbegriff, zu dem das Spiel gecacht wurde (optional)
 * @property filterHash Hashwert der Filtereinstellungen (optional)
 */
...
data class GameCacheEntity(
    ...
    val movies: String,
    /** Zeitstempel, wann das Spiel gecacht wurde */
    val cachedAt: Long = System.currentTimeMillis(),
    /** Suchbegriff, zu dem das Spiel gecacht wurde (optional) */
    val searchQuery: String? = null,
    /** Hashwert der Filtereinstellungen (optional) */
