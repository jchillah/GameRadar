...
class FavoritesRepositoryTest {
    ...
    fun addAndGetFavorite() = runTest {
        ...
        val addResult = repository.addFavorite(context, game)
    ...
    fun getAllFavorites() = runTest {
        ...
        // When
        val context = ApplicationProvider.getApplicationContext<Context>()
        repository.addFavorite(context, game1)
        repository.addFavorite(context, game2)
    ...
    fun isFavorite() = runTest {
        ...
        repository.addFavorite(context, game)
    ...
    fun removeFavorite() = runTest {
        ...
        repository.addFavorite(context, game)
        val isFavoriteBefore = repository.isFavorite(1)
        val removeResult = repository.removeFavorite(context, 1)
        val isFavoriteAfter = repository.isFavorite(1)
    ...
    fun toggleFavorite() = runTest {
        ...
        // When
        val context = ApplicationProvider.getApplicationContext<Context>()
        val toggleResult1 = repository.toggleFavorite(context, game)
        val isFavoriteAfter1 = repository.isFavorite(1)
        val toggleResult2 = repository.toggleFavorite(context, game)
    ...
    fun clearAllFavorites() = runTest {
        ...
        val clearResult = repository.clearAllFavorites(context)
    ...
    fun handleErrorWhenAddingFavorite() = runTest {
        ...
        // When
        val context = ApplicationProvider.getApplicationContext<Context>()
        val result = repository.addFavorite(context = context, game = invalidGame)
